  ...
  const fetchAlamat = async () => {
    try {
      const res = await fetch(
        `/api/alamat?q=${encodeURIComponent(searchQuery)}`
      );
      const data = await res.json();
        ...
        <div className="flex flex-col w-full rounded-4xl">
            ...
            <div className="ps-7">
              {user?.src_img_profile ? (
                ...
                <div
                  ...
                  style={{
                    backgroundColor: generateStableColor(
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-2">
                    ...
                    <ReuseButton className="w-full">
                      <div className="flex items-center justify-center gap-2 py-3">
                        ...
                        <svg
                          className="w-5 h-5 text-indigo-900 group-hover:text-white transition-colors duration-300" /* icon */
                        />
                      </div>
                    </ReuseButton>
                  </div>
          ...
          <div className="mt-4 border-1 border-[#220593] rounded-3xl p-6">
                ...
                {alamatList.length === 0 ? (
                  ...
                  alamatList.map((alamat) => (
                    <div
                      ...
                      className="p-8 bg-[#F6F7FB] rounded-3xl text-wrap w-70 min-w-[280px] max-w-[320px] flex-shrink-0"
                    >
                      {/* Label alamat utama */}
                      ...
                      {/* Info utama alamat */}
                      <div className="text-lg font-semibold mb-2 truncate max-w-full">
                        {alamat.nama_alamat}
                      </div>
                      <div className="text-sm font-extralight mb-3 line-clamp-4 break-words max-w-full">
                        {alamat.lokasi}
                      </div>
                ...
                <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-50">
                  <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg relative">
                    ...
                    <p className="text-gray-700 mb-6 text-center">
                      Apakah kamu yakin ingin menghapus alamat{" "}
                      <strong>{alamatToDelete?.nama_alamat}</strong>?
                    </p>
            ...
            <ReuseButton className="w-full" onClick={() => setShowModal(true)}>
              <div className="py-3 font-semibold">Tambah Alamat</div>
            </ReuseButton>
            {showModal && (
              <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-50">
                <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg relative">
                  ...
                  >
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFormAlamat({ ...formAlamat, lokasi: e.target.value })
                      }
                      className="border border-gray-300 px-4 py-2 rounded"
                      required
                    />
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormAlamat({ ...formAlamat, note: e.target.value })
                      }
                      className="border border-gray-300 px-4 py-2 rounded"
                    />
