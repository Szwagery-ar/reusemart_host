  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mb-4 border border-[#220593] p-6 rounded-4xl">
        ...
        <div className="text-3xl text-[#220593] font-semibold">
          {user?.poin_loyalitas} Reusepoint
        </div>
      </div>
      ...
      <div className="border border-[#220593] p-6 rounded-4xl">
        ...
        <div className="text-xs font-semibold mb-4">
          Ambil merchandise kamu di kantor kami ya!
        </div>

        <div className="space-y-4">
          {klaim.length === 0 ? (
            <div className="text-center text-gray-500 italic text-4xl p-8">
              Belum tukar merch? Tukarkan sekarang
            </div>
          ) : (
            klaim.map((item) => (
              <div
              ...
              >
                <div className="flex items-center gap-4">
                  <img
                    src={item.src_img || "/placeholder.png"}
                    alt="Merch"
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-100">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96">
              ...
              <p className="mb-4">
                Apakah Anda yakin ingin menghapus klaim ini?
              </p>
      ...
      <div className="border border-[#220593] p-6 rounded-4xl">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Kumpulkan Reusepoint dari setiap transaksi dan tukarkan dengan
          merchandise menarik.
        </p>
            ...
            >
              ...
              <div className="">
                <div className="text-sm font-semibold mb-1 text-right">
                  Poin ditukar:{" "}
                  {(jumlahTukar[item.id_merchandise] || 0) * item.jumlah_poin}
                </div>
                <div className="flex gap-2 justify-end">
