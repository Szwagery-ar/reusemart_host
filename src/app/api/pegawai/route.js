...
//         // Insert pegawai baru
//         const [result] = await pool.query(
//             "INSERT INTO pegawai (nama, email, password, no_telepon, tanggal_lahir, komisi, nama_jabatan) VALUES (?, ?, ?, ?, ?, ?, ?)",
//             [nama, email, hashedPassword, no_telepon, tanggal_lahir, komisi || 0, nama_jabatan]
//         );
