      ...
      <div className="px-20 mt-20">
        ...
        <div className="flex gap-5 justify-center mt-3">
          ...
          <div className="py-20 flex-auto bg-[#220593] rounded-4xl">
            <div className="pt-3 ps-10 font-[Montage-Demo] text-white text-9xl">
              CARI <span className='text-[#CDE7FF]'>APAPUN</span> <br /> DI REUSEMART
            </div>
            <div className='p-3 ms-10 ps-3 text-white font-semibold border-s-5'>
              Semua kategori, satu tempat, cari barang bekas berkualitas <br /> yang mau kamu bawa pulang
            </div>
          </div>
          <div className="flex flex-row gap-5">
            <div className='grid grid-cols-1 gap-5'>
              ...
              <div className="bg-[#220593] rounded-4xl p-4">
                <h5 className='text-white w-50'>Langsung cek koleksi barang terbaik kami</h5>
                <button className="bg-white px-8 py-3 mt-2 inline-flex gap-5 text-[#220593] rounded-4xl font-semibold">Belanja Sekarang
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          <div className="bg-[#220593] rounded-4xl p-3 inline-flex">
            <img src="/images/home/linear/Tag Price.png" alt="Tag Price" className='scale-80' />
            <div className="place-content-center">
              <div className='text-white text-3xl font-[Montage-Demo]'>HARGA YANG RASIONAL</div>
              <div className='text-white text-sm mt-3'>Kamu tetap bisa dapetin barang berkualitas tanpa bikin dompet menjerit.</div>
            </div>
          </div>
          <div className="bg-[#220593] rounded-4xl p-3 inline-flex">
            <img src="/images/home/linear/verified check.png" alt="Verified Check" className='scale-80' />
            <div className="place-content-center">
              <div className='text-white text-3xl font-[Montage-Demo]'>BARANG BEKAS NGGAK ASAL</div>
              <div className="text-white text-sm mt-3">Semua barang udah di cek — bebas cacat, asli, dan pastinya kece.</div>
            </div>
          </div>
          <div className="bg-[#220593] rounded-4xl p-3 inline-flex">
            <img src="/images/home/linear/hand stars.png" alt="Hand Stars" className='scale-80' />
            <div className="place-content-center">
              <div className='text-white text-3xl font-[Montage-Demo]'>KEUNTUNGAN MAKSIMAL</div>
              <div className="text-white text-sm mt-3">Tukar poin dari setiap transaksi jadi diskon atau merchandise keren.</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 flex place-content-between ">
          ...
          <div className="inline-flex gap-1 font-medium">Lihat Semua
          ...
          {barang.map((item) => (
            <div key={item.id_barang} className="">
              <div className="bg-gray-300 rounded-4xl h-[300px]">
                <img
                  src={item.gambar_barang.length > 0 ? item.gambar_barang[0].src_img : '/path/to/default-image.jpg'}
                  alt={item.nama_barang}
                  className="object-cover w-full h-full rounded-t-4xl"
                />
              </div>

              <div className="text-lg font-semibold mt-2">{item.nama_barang}</div>
              <div className="text-md font-medium">{formatPrice(item.harga_barang)}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-4 grid-rows-3 gap-4">
          ...
          <div className="bg-gray-500 col-span-2">CENTER PART
          </div>
        ...
        <div className="grid grid-cols-2 gap-5 mt-20">
          <div className="text-center rounded-4xl p-8 bg-[radial-gradient(ellipse_130.87%_392.78%_at_121.67%_0.00%,_#26C2FF_0%,_#220593_90%)] grid grid-cols-3">
            <div className="text-white text-left col-span-2">
              <h3 className='font-[Montage-Demo] text-4xl'>LOYALTY REWARDS BUAT KAMU YANG SETIA</h3>
          ...
          <div className="text-center rounded-4xl p-8 bg-[radial-gradient(ellipse_130.87%_392.78%_at_121.67%_0.00%,_#26C2FF_0%,_#220593_90%)] grid grid-cols-3">
            <div className="text-white text-left col-span-2">
              <h3 className='font-[Montage-Demo] text-4xl'>GABUNG JADI PENITIP SEKARANG!</h3>
        ...
        <div className="text-center text-7xl font-medium bg-[#EDF6FF] rounded-4xl p-30 mt-20">Download apk sekarang!</div>
      </div>
      <Footer />
    </div>
  );
