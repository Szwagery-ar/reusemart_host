                    ...
                    <tbody className="bg-white divide-y divide-gray-100">
                        ...
                        {transaksiList.length === 0 ? (
                            ...
                            transaksiList.map((item, index) => (
                                <tr key={item.id_transaksi} className="rounded-xl border border-black text-sm hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-right font-medium">
                                        <div className="relative dropdown-action flex justify-center items-center">
                                            <button
                                                onClick={() =>
                                                    setActiveDropdown(activeDropdown === item.id_transaksi ? null : item.id_transaksi)
                                                }
                                ...
                                <div>
                                    {viewData.barang.map((b, i) => (
                                        <div key={i} className="flex">
                                            ...
                                            <div className="flex-1" >{formatRupiah(b.harga_barang)}</div>
                                        </div>
                                    ))}
                                </div>
                                <div className="flex">
