...
export default function RegisterOrg() {
  ...
  return (
    <div className="min-h-screen w-full flex text-white bg-[radial-gradient(ellipse_130.87%_392.78%_at_-1.67%_100%,_#26C2FF_0%,_#220593_90%)]">
      ...
      <div className="z-3 w-full lg:w-3/5 flex flex-col justify-center px-10 xl:px-25 lg:px-20 md:px-30 py-10">
        <h3 className="text-5xl lg:text-6xl md:text-6xl mb-5 font-[Montage-Demo] text-center">
          Mari Salurkan Manfaat Bersama
        </h3>
        <h5 className="text-lg text-center mb-4">
          Daftarkan organisasi atau komunitas sosialmu untuk menerima barang
          layak pakai dari program donasi ReUseMart.
        </h5>
            ...
            <div className="bg-white rounded-4xl shadow-2xl text-center max-w-lg w-full">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 text-md font-medium">
                  Halo <b>{name}</b>, selamat datang di Reusemart! Terima kasih
                  sudah bergabung. Untuk mulai menggunakan akunmu, kami perlu
                  memverifikasi email kamu. Kami sudah kirimkan link
                  verifikasinya, yuk cek email kamu dan konfirmasi!.
                </p>
                <RippleButton
