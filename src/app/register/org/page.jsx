    ...
    return (
        <div className="min-h-screen w-full flex text-white bg-[radial-gradient(ellipse_130.87%_392.78%_at_-1.67%_100%,_#26C2FF_0%,_#220593_90%)]">
            ...
            <div className="z-3 w-full lg:w-3/5 flex flex-col justify-center px-10 xl:px-25 lg:px-20 md:px-30 py-10">
                <h3 className='text-5xl lg:text-6xl md:text-6xl mb-5 font-[Montage-Demo] text-center'>Mari Salurkan Manfaat Bersama</h3>
                <h5 className='text-lg text-center mb-4'>Daftarkan organisasi atau komunitas sosialmu untuk menerima barang layak pakai dari program donasi ReUseMart.</h5>
