      ...
      {loading ? (
        ...
        <div>
          ...
          {pembayarans.map((p) => (
            <div
              key={p.id_pembayaran}
              className="grid grid-cols-[100px_1fr_180px_200px_200px_140px] p-3 border-b text-sm items-center"
            >
              ...
              <div className="flex justify-center gap-2">
                {p.status_pembayaran === "PENDING" ? (
                  <>
                    <button
                      onClick={() =>
                        handleKonfirmasi(p.id_pembayaran, "CONFIRMED")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleKonfirmasi(p.id_pembayaran, "FAILED")
                      }
