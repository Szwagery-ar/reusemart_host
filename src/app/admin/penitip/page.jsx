  ...
  return (
    <div className="p-6 relative">
      <WithRole allowed={["CS", "Superuser"]}>
        ...
        <div className="overflow-x-auto rounded-xl flex flex-col">
                ...
                <tr key={index} className="odd:bg-white even:bg-gray-100 hover:bg-gray-200">
                  <td className="px-6 py-4 text-right text-sm font-medium">
                    <div className="relative dropdown-action flex justify-center items-center" ref={dropdownRef}>
                      ...
                      {activeDropdown === p.id_penitip && (
                        <div className="dropdown-action absolute left-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-md z-10">
                          <button
