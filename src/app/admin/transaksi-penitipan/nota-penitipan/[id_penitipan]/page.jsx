...
export default function NotaPenitipanPage() {
    ...
    return (
        <div className="p-10 max-w-2xl mx-auto">
            <div ref={notaRef} className="print-area border rounded shadow text-sm bg-white text-black p-6">
                ...
                <div className="border p-4 rounded">
                    ...
                    {(nota.barang || []).map((b, i) => (
                        <div key={i} className="mb-1">
                            <p>{b.nama_barang}</p>
                            <p>Harga : {formatRupiah(b.harga_barang)}</p>
                            {b.tanggal_garansi && (
                                <p>
                                    Garansi ON : {new Date(b.tanggal_garansi).toLocaleString('id-ID', {
