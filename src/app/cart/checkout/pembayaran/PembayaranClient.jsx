        ...
        <div className="p-6 md:p-12 bg-[#EDF6FF] min-h-screen">
            ...
            <div className="bg-white p-6 rounded shadow-md space-y-4">
                <p className="text-gray-600">
                    Harap unggah bukti pembayaran dalam waktu <strong>{formatTimer(timeLeft)}</strong> menit sebelum transaksi dibatalkan.
                </p>
                <p>Total yang harus dibayar: <strong>{formatRupiah(transaksi.harga_akhir)}</strong></p>

                <input type="file" accept="image/*" onChange={handleFileChange} />
                {imagePreview && (
                    <div className="mt-4">
                        <Image src={imagePreview} alt="Preview" width={300} height={300} className="rounded shadow" />
                    </div>
                )}
