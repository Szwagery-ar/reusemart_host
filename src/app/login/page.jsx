...
const GOOGLE_CLIENT_ID =
  "627202337032-4llrgl8hajk2bnna4n0s5tja5rffs0oq.apps.googleusercontent.com";
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row text-white bg-[radial-gradient(ellipse_130.87%_392.78%_at_101.67%_0.00%,_#26C2FF_0%,_#220593_90%)]">
      ...
      <div className="z-3 w-full lg:w-1/2 flex flex-col justify-center px-10 xl:px-25 lg:px-20 md:px-30 py-10">
        <h3 className="text-5xl lg:text-6xl md:text-6xl mb-3 font-[Montage-Demo] text-center">
          MASUK AJA DULU
        </h3>
        <h5 className="text-lg text-center mb-4">
          Login sekarang lalu lanjut eksplor barang-barang kece di <br />{" "}
          ReUseMart.
        </h5>

        <GoogleButton
          className="w-full bg-white text-indigo-950 font-semibold py-3 px-6 rounded-full mb-4"
        ...
        <form onSubmit={handleLoginSubmit}>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="inline-flex items-center">
              ...
              <label
                className="cursor-pointer ml-3 text-white text-base"
                htmlFor="ripple-on"
              >
                Ingat Saya
              </label>
      ...
      {showForgotPasswordModal && (
        <div className="fixed inset-0 bg-black/25 flex items-center justify-center z-50">
          <div className="bg-white p-10 rounded-4xl w-full max-w-lg">
            {step === 1 && (
              <>
                <h2 className="text-4xl font-bold text-indigo-900 text-center mb-5">
                  Lupa Password?
                </h2>
                <p className="text-black font-extralight text-md text-center mb-6">
                  Jangan khawatir, Kami akan bantu mereset password Anda.
                </p>
                <label
                  htmlFor="email"
                  className="block text-lg font-medium text-indigo-900 mb-1"
                >
                  Email
                </label>
            ...
            <p
              className="text-indigo-900 mt-4 font-medium flex items-center justify-center gap-2 cursor-pointer"
