            ...
            {uniqueImages.map((gambar, index) => (
              <img
                ...
                className={`w-24 h-24 object-cover rounded-xl cursor-pointer ${
                  previewImg === gambar.src_img ? "ring-3 ring-blue-600" : ""
                }`}
              />
            ))}
          </div>
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            <RippleButton
              ...
              className="text-white px-6 py-2 w-full rounded-4xl bg-[radial-gradient(ellipse_130.87%_392.78%_at_121.67%_0%,_#26C2FF_0%,_#220593_90%)]"
            >
              Beli Sekarang
            </RippleButton>
            ...
            <div className="fixed inset-0 z-99 bg-black/40 flex justify-center items-center">
              <div className="bg-white p-6 rounded-lg max-w-sm w-full">
                ...
                <p className="mb-4 text-sm text-gray-700">
                  Anda harus login terlebih dahulu untuk melanjutkan pembelian.
                </p>
          ...
          <div className="mb-4">
            <div
              className={`mt-4 text-ellipsis overflow-hidden transition-all duration-300 ease-in-out ${
                isExpanded ? "" : "h-[350px]"
              }`}
            >
          ...
          <div className="px-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <div className="font-semibold">{barang.berat_barang} gram</div>
              <div>Status garansi</div>
              <div className="font-semibold">
                {barang.tanggal_garansi ? (
                  <span className="text-green-500">
                    Berlaku hingga: {formatDate(barang.tanggal_garansi)}
                  </span>
                ) : (
                  <span className="text-red-500">Tidak Ada</span>
                )}
              </div>
              <div>Diterima ReUseMart sejak tanggal</div>
              <div className="font-semibold">
        ...
        <div className="mb-4 border-b-2 border-indigo-500 p-4 flex gap-4 items-center">
          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            <p className="text-sm text-gray-500">
              Ada pertanyaan seputar pengiriman, promo, atau lainnya?
              <a className="font-semibold"> Chat Customer Service</a>
            </p>
          </div>
          <ReuseButton onClick={() => setShowModal(true)}>
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          {diskusi.length > 0 ? (
            diskusi.map((item) => (
              <div
                key={item.id_diskusi}
                className="rounded-2xl p-5 flex gap-4 items-center w-full md:w-[90%] bg-[#f6f7fb]"
              >
                <div className="flex flex-col justify-center flex-1">
            ...
            <div className="fixed inset-0 bg-black/20 flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-lg w-full max-w-lg">
                <h2 className="text-lg font-bold mb-4">
                  Tambah diskusi untuk {barang.nama_barang}
                </h2>
